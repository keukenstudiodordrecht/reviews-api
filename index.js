...
const reviewPlatforms = [
  ...
  },
  {
    name: "Google",
    adress:
      "https://www.google.com/search?q=keukenstudio+dordrecht+reviews&oq=keukenstudio+dordrecht+reviews&aqs=chrome..69i57j69i60l2.4572j0j4&sourceid=chrome&ie=UTF-8#lrd=0x47c42f24cd67cfdb:0xd25fbfad59c1ae80,1,,,",
  },
  {
    name: "Facebook",
...
reviewPlatforms.forEach((reviewPlatform) => {
  axios.get(reviewPlatform.adress).then((response) => {
